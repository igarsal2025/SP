"""
Tests para el sistema de permisos ABAC y evaluación de políticas
"""
...
class AccessPolicyEvaluateViewTests(APITestCase):
    ...
    def test_evaluate_action_with_conditions(self):
        ...
        # Política que deniega a técnicos (mayor prioridad que la base)
        AccessPolicy.objects.create(
            company=self.company,
            action="dashboard.view",
            conditions={"role": "tecnico"},
    ...
    def test_evaluate_multiple_actions(self):
        ...
        # Política que deniega wizard.submit a técnicos (mayor prioridad)
        AccessPolicy.objects.create(
            company=self.company,
            action="wizard.submit",
            conditions={"role": "tecnico"},
        ...
        # wizard.submit debe estar denegado (solo PM, técnico denegado explícitamente)
    ...
    def test_evaluate_unauthenticated(self):
        ...
        # Django REST Framework puede retornar 401 o 403 para no autenticados
